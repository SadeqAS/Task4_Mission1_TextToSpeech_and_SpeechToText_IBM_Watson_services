...
apikey1 = 'KnlQ_B7ciNy9RwNxLxLBQ7n5hgBHTTT-YVWH_5jJ0j5q'

url1 = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/754c0136-e462-4d34-abbc-b37001eb2ea8'

authenticator = IAMAuthenticator(apikey1)
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url(url1)
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        Save_Text = (data['results'][0]['alternatives'][0]['transcript'])
        print(Save_Text)
        with open('Res.txt', 'w') as out:
            out.writelines(Save_Text)
        ...
        with open('./SSSSS.mp3', 'wb') as audio_file:
            res2 = tts.synthesize(
                text, accept='audio/mp3', voice='en-GB_JamesV3Voice').get_result()
